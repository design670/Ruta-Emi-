...
import { Menu, X, ChevronRight, BookOpen, Stethoscope, AlertCircle } from 'lucide-react';
import heroPhoto from './hero-photo.avif';
import logoRutaEmi from './Logo Ruta EmiRecurso 1.svg';

export default function RutaEmiLanding() {
  ...
  const modulos = [
    {
      ...
      descripcion: 'Itinerario intensivo enfocado en la estabilización rápida, toma de decisiones bajo presión y abordaje protocolizado del paciente.',
      cursos: 12,
      duracion: '20 semanas',
    ...
    },
    {
      ...
      descripcion: 'Entrenamiento metodológico para construir diagnósticos diferenciales sólidos a partir de la presentación clínica.',
      cursos: 8,
      duracion: '14 semanas',
    ...
    },
    {
      ...
      descripcion: 'Guía práctica para la selección racional de fármacos, dosificación y prevención de eventos adversos.',
      cursos: 9,
      duracion: '12 semanas',
  ...
  const recursos = [
    {
      tipo: 'PDF y Guías',
      descripcion: 'Protocolos, guías de manejo y resúmenes clínicos descargables.',
      icono: 'doc'
    },
    {
      tipo: 'Infografías',
      descripcion: 'Conceptos complejos sintetizados en formato visual y memorable.',
      icono: 'chart'
    },
    {
      tipo: 'Enlaces',
      descripcion: 'Recursos complementarios, artículos y referencias actualizadas.',
      icono: 'link'
    }
  ];
          ...
          <div className="md:hidden bg-white border-t border-slate-200">
            <div className="px-6 py-4 space-y-4">
              ...
              <div className="pt-4 border-t border-slate-200 space-y-3">
                <Link
                  to="/iniciar-sesion"
                  className="block w-full py-2.5 text-center text-slate-700 text-sm font-medium"
                >
                  Iniciar sesión
                </Link>
                <Link
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start mb-12">
            ...
            <div className="space-y-6 md:pt-14">
              <p className="text-lg text-slate-600 leading-relaxed">
                Ruta EMI organiza el aprendizaje mediante recorridos progresivos, casos
                clínicos y recursos aplicables para ayudarte a consolidar criterio médico y
              ...
              {[
                {
                  ...
                  descripcion:
                    'Selecciona el itinerario que mejor responda a tu momento formativo y tus objetivos clínicos.',
                ...
                },
                {
                  ...
                  descripcion:
                    'Recorre lecciones concisas diseñadas para asimilar conceptos clave sin saturación teórica.',
                ...
                },
                {
                  ...
                  descripcion:
                    'Resuelve casos clínicos interactivos y utiliza herramientas de apoyo en tus decisiones reales.',
                ...
                >
                  ...
                  <div className="relative flex-1 min-h-[220px] bg-teal-800 overflow-hidden">
                    <div
                      ...
                      style={{
                        backgroundImage:
                          'repeating-linear-gradient(135deg, rgba(255,255,255,0.5) 0, rgba(255,255,255,0.5) 2px, transparent 2px, transparent 14px)'
                      }}
                    />
                  </div>
                </button>
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
            <div>
              ...
              <p className="text-lg text-slate-600 max-w-2xl">
                Aprende a decidir en escenarios reales. Casos clínicos interactivos inspirados
                en la práctica clínica de la Sociedad Colombiana de Pediatría (SCP) y urgencias
                hospitalarias.
              </p>
            </div>
            <button
              ...
              return (
                ...
                >
                  <div className={`relative h-40 bg-gradient-to-br ${scheme.overlay}`}>
                    ...
                    />
                    <span className={`absolute top-3 left-3 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wide ${scheme.badge}`}>
                      {caso.especialidad}
                    </span>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {recursos.map((recurso, idx) => {
              ...
              return (
                <div key={idx} className={`card-hover rounded-2xl p-8 text-white ${scheme}`}>
                  <div className="mb-6">
      ...
      <section className="py-24 md:py-32 px-6 bg-gradient-to-r from-sky-100 via-cyan-50 to-sky-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-600 mb-10 max-w-2xl mx-auto">
            Crea tu cuenta para acceder a cursos, casos clínicos y recursos especializados.
            Guarda tu progreso y avanza a tu ritmo.
          </p>
        ...
        <section className="py-16 md:py-24 px-6 min-h-screen bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-sm text-slate-400 mb-12">
              Los {todosLosCasosSCP.length} casos marcados con vista rápida se pueden analizar
              dentro de Ruta EMI; el resto abre el caso original en scp.com.co.
            </p>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {todosLosCasosSCP.map((item, idx) => {
                ...
                const casoDetalle = item.casoRef ? casos.find((c) => c.id === item.casoRef) : null;

                const CardTag = casoDetalle ? 'button' : 'a';
                const cardProps = casoDetalle
                  ? { onClick: () => setModalCaso(casoDetalle) }
                ...
                return (
                  ...
                  >
                    <div className={`relative h-32 bg-gradient-to-br ${scheme.overlay}`}>
                      ...
                      {casoDetalle && (
                        <span className={`absolute bottom-3 right-3 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wide ${scheme.badge}`}>
                          Vista rápida
                        </span>
                      )}
                    </div>
        ...
        <section className="py-16 md:py-24 px-6 min-h-screen bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mb-12">
              Todos los itinerarios formativos disponibles en Ruta EMI, con su duración,
              cantidad de cursos y temas cubiertos.
            </p>

            <div className="grid sm:grid-cols-2 gap-6">
              {modulos
                .filter((m) => !m.esCatalogo)
                .map((modulo) => {
                  const scheme =
                    modulo.id === 'urgencias'
                      ? { bg: 'bg-teal-600', badge: 'bg-teal-800 text-teal-100', tag: 'bg-teal-800 text-teal-100', text: 'text-white', textMuted: 'text-white/80' }
                      : modulo.id === 'farmacologia'
                      ? { bg: 'bg-violet-800', badge: 'bg-violet-900 text-violet-100', tag: 'bg-violet-900 text-violet-100', text: 'text-white', textMuted: 'text-white/80' }
                      : { bg: 'bg-blue-50 border border-blue-100', badge: 'bg-blue-200 text-blue-800', tag: 'bg-blue-200 text-blue-800', text: 'text-slate-900', textMuted: 'text-slate-600' };
                  ...
                  return (
                    ...
                    >
                      ...
                      <h3 className={`text-2xl font-bold mb-3 leading-snug ${scheme.text}`}>
                        {modulo.titulo}
                      </h3>
                      <p className={`text-sm leading-relaxed mb-6 ${scheme.textMuted}`}>
                        {modulo.descripcion}
                      </p>
